...
- **Peer deps**: exact pins for libraries the toolkit wraps directly and tests
  against, `>=` minimum versions for libraries users likely already have — see
  [ADR-009](/docs/architecture/adrs#adr-009-optional-peer-dependency-pattern)
