...
2. **Dynamic imports** — peer deps are loaded at runtime, not compile time (see [ADR-009](/docs/architecture/adrs#adr-009-optional-peer-dependency-pattern) for the full pattern)
