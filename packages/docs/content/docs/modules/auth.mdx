---
title: auth
description: API key validation, timing-safe comparison, and multi-tenant context
---

## Overview

The `auth` module provides API key authentication with timing-safe comparison and multi-tenant context extraction from request headers.
